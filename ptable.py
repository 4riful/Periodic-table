...
usr=input(c_c("[NB. Select a number from above. ]\n\n\n➡➡  ","red","bold=True"))
...
if usr=="3":
	...
	if atom.lower()=="h":
		...
		ptb("Curium","1944","96","96","151","96","247.0703","1340","Solid","7","n/a","f","Antiferromagnetic-Paramagnetic")
	elif atom.lower()=="bk":
